...
-- À la vérification d'un paiement : activation immédiate du plan
...
-- Action admin : passer un paiement manual_review → verified/rejected avec note
...
-- Repassage du diagnostic : gratuit une fois, puis après 30 jours ou déblocage admin
...
-- Déblocage admin d'un repassage
...
-- Indicateurs du tableau de bord admin
